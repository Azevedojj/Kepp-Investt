...
import { TrendingUp, Mail, Lock, User, ArrowRight, AlertCircle, Sparkles, ChevronRight } from 'lucide-react';
...
export const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const banStatus = await dbService.checkEmailBanStatus(email);
      if (banStatus.isBanned) {
        setError(`Este email não pode ser utilizado pois está associado a uma conta banida. Motivo: ${banStatus.reason}`);
        setLoading(false);
        return;
      }
      ...
      if (err instanceof Error) {
        ...
        } else if (err.message === 'Email já cadastrado') {
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg w-full max-w-4xl flex flex-col md:flex-row overflow-hidden relative z-10 border border-gray-100">
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-12 md:w-[45%] flex flex-col justify-center relative overflow-hidden">
          <div className="relative">
            ...
            <h2 className="text-3xl font-bold text-white mb-6">Hello, Welcome!</h2>
        ...
        <div className="p-12 md:w-[55%] flex flex-col justify-center bg-white relative">
          <div className="relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {success && (
                <div className="bg-green-50 border border-green-200 text-green-600 px-4 py-3 rounded-full animate-fadeIn">
